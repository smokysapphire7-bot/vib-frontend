...
const WA_LINK = `https://wa.me/916282878843?text=Hi%20Vape Delivery Bangalore%2C%20I%20want%20to%20order%20a%20vape%20in%20Bangalore`;
...
${CTA()}`,
  ...
  // ─── NEW: ELFBAR BANGALORE ────────────────────────────────────────────────
  {
    ...
    metaTitle: "Buy Elfbar in Bangalore | Raya D1, D3, Ice King | Vape Delivery Bangalore",
...
<h2>Why Buy Elfbar from Vape Delivery Bangalore?</h2>
...
${CTA()}`,
  ...
  // ─── NEW: CALIBURN POD DEVICE BANGALORE ──────────────────────────────────
  {
    ...
    metaTitle: "Buy Caliburn Pod Device in Bangalore | G4, G5, KOKO | Vape Delivery Bangalore",
...
${CTA()}`,
  ...
  // ─── NEW: NICOTINE POUCHES BANGALORE ─────────────────────────────────────
  {
    ...
    metaTitle: "Buy Nicotine Pouches in Bangalore | ZYN Cool Mint, Velo | Vape Delivery Bangalore",
...
${CTA()}`,
  ...
  // ─── D3 PRO RAISING ISSUES WARNING ───────────────────────────────────────
  {
    ...
    metaTitle: "Elfbar D3 Pro Issues Bangalore — Read Before Buying | Vape Delivery Bangalore",
...
${CTA()}`,
  ...
  // ─── HOW TO ORDER VAPE IN BANGALORE ──────────────────────────────────────
  {
    ...
    metaTitle: "How to Order Vape Delivery Bangalore on WhatsApp | Vape Delivery Bangalore",
...
${CTA()}`,
  ...
  // ─── BEST VAPE FOR BEGINNERS BANGALORE ───────────────────────────────────
  {
    ...
    metaTitle: "Best Vape for Beginners Bangalore 2025 | Starter Guide | Vape Delivery Bangalore",
...
${CTA()}`,
  ...
  // ─── VAPE VS CIGARETTE BANGALORE ─────────────────────────────────────────
  {
    ...
    metaTitle: "Vaping vs Smoking Cigarettes Bangalore | Switch Guide | Vape Delivery Bangalore",
...
${CTA()}`,
  ...
  // ─── ELFBAR D3 PRO RAISING ISSUES ────────────────────────────────────────
  {
    ...
    metaTitle: "Elfbar D3 Pro Issues in Bangalore | What to Know Before Buying | Vape Delivery Bangalore",
...
${CTA()}`,
  ...
  // ─── ELFBAR TRIO VS RAYA D1 ──────────────────────────────────────────────
  {
    ...
    metaTitle: "Elfbar Trio vs Raya D1 Bangalore | Honest Puff Count Comparison | Vape Delivery Bangalore",
...
${CTA()}`,
  ...
  // ─── HOW TO MAKE YOUR VAPE LAST LONGER ───────────────────────────────────
  {
    ...
    metaTitle: "Make Disposable Vape Last Longer | Tips for Bangalore Vapers | Vape Delivery Bangalore",
