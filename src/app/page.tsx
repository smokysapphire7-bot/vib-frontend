...
export const metadata: Metadata = {
  title: "Buy Vape in Bangalore – 20-30 Min Delivery | VapeDeliveryBangalore.com",
  description:
    ...
    <>
      ...
      <section className="section">
        <div className="container">
          ...
          <p>
            ...
            Koramangala, or want to buy vape near Whitefield — Vape Delivery Bangalore
      ...
      <section className="cta-section">
        <div className="container">
          ...
          <div className="btn-group" style={{ justifyContent: "center" }}>
            <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=Hi%20Vape Delivery Bangalore%2C%20I%20want%20to%20order%20a%20vape%20in%20Bangalore`} target="_blank" rel="noopener noreferrer" className="btn-whatsapp">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "mainEntity": [
          ...
          { "@type": "Question", "name": "How do I order vape online in Bangalore?", "acceptedAnswer": { "@type": "Answer", "text": "You can order vape online in Bangalore by visiting VapeDeliveryBangalore.com, selecting your product and flavour, and completing checkout. You can also WhatsApp us directly at +91 6282878843 to place an order." } },
        ]
      })}} />
    </>
  );
