      ...
      <section className="cta-section">
        <div className="container">
          ...
          <div className="btn-group" style={{ justifyContent: "center" }}>
            <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=Hi%20VapeInBangalore%2C%20I%20want%20to%20order%20a%20vape%20in%20Bangalore`} target="_blank" rel="noopener noreferrer" className="btn-whatsapp">
